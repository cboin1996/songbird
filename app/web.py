...
class SimpleSession:
    def __init__(self, name: str, root_url: str, credentials: Optional[dict]={}, headers: Optional[dict]={}):
        self.name = name
    ...
    def enter_search_form(self, search_url: str, form_url: Optional[str]=None, payload: Optional[dict]=None, render_timeout: Optional[int]=10):
        """
        ...
        try:
            ...
            logger.exception(f"Exception occurred while performing GET request to {search_url},\n\t with code {response.status_code},\n\t body {response.content}")
            return None
